---
title: 从0到1构建计算机(8/10)--高级语言：Jack
tags: 计算机基础 从0到1构建计算机
---
前一篇我们实现了Hack虚拟机，定义了虚拟机指令，本篇我们将设计一门高级语言：Jack。Jack是基于面向的对象的语言，具备现代高级语言的基本特性和风格，但是语法相对简单，且不支持继承等高级属性。本篇的内容非常简单，主要是介绍Jack的一些语法。

### Jack-Hello, World

学习新语言第一步，写一个Hello, World。一个Jack程序一定要有一个Main类，且包含main方法，这是程序的入口函数。
...
学习完Hello, World，下面让我们花十分钟时间来精通Jack
